...
2. **Lokální server** (doporučeno pro plnou funkcionalitu):
   ```bash
   # Python 3
...
Aplikace využívá:
- **Vlastní implementace mapy** - žádné externí knihovny
- **Simulované mapové rozhraní** - funkční bez připojení k internetu
...
- **Vlastní mapa** - nezávislá na externích knihovnách
