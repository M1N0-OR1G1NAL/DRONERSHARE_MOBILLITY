...
1. **FlightTierSystem Concern** (`app/models/locomotive/concerns/account/flight_tier_system.rb`)
   ...
   - 185 lines of carefully designed tier transition logic
...
- `app/models/locomotive/account.rb` (new)
...
- `app/views/locomotive/shared/account/_navigation.html.slim` (new)

**Routes:**
- `config/routes.rb` (new)
